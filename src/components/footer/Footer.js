  ...
  return (
    <div className='bottom-0 hidden mt-48 md:p-10 bg-footer h-auto md:flex flex-row space-x-8 justify-evenly flex-wrap'>
        ...
        <div className='flex flex-col'>
            <div id='f-21'>
                <span className='text-left text-gray-800 tracking-normal'>Follow us</span>
            ...
            <div className='mt-6'>
                <span className='text-left text-gray-800 tracking-normal mb-4'>Can we help you?</span>
                <div className=' text-center h-1 bg-slate-900 w-12 mt-2'></div>
        ...
        <div className='flex flex-col align-top '>
            ...
            <p className='text-sm flex flex-wrap'>
                ...
                and we do our best to make your shopping experience as pleasant as possible.<br/>
                Please email us at Info@kickzstore.com with any questions
            </p>
        </div>
        <div className='flex flex-col align-top '>
            <span className='text-left text-gray-800 tracking-normal mb-2'>Newsletter</span>
            <span className=' text-left h-1 bg-slate-900 w-12 mb-4'></span>
            <h4>Be the first who learns about our <br/>great promotions!</h4>
