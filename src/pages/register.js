...
export default function Register() {
  ...
  const openNotificationV1 = (type, response) => {
    api[type](response);
  };
  ...
  const handleSubmit = async (values) => {
    ...
    const url =
      process.NODE_ENV === "production"
        ? "https://kick-store-next-harish876.vercel.app/api/auth/signup"
  ...
  return (
    <Layout>
      ...
      <section className="w-3/4 mx-auto flex flex-col gap-10">
        <div className="title">
          <article className="text-gray-800 text-4xl font-bold py-4">
            Kick Store
          </article>
        ...
        >
          ...
          {formik.errors.username && formik.touched.username ? (
            <span className="w-3/4 flex justify-center mx-auto text-rose-600">
