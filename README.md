...
## FYI
If the URL does not open up in first try, please keep refreshing. I dont know why vercel keeps giving a 504 error on the first click. Free Tier is doomed

## Project Info
1. Concept Shoe Store with 3D renderings using three and react fiber and Next js
2. User Auth done using next-auth
